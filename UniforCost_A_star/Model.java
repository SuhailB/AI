...
class Model {
	...
	public static double LOWEST_COST_SQUARE;
	...
	void initGame() throws Exception {
		...
		LOWEST_COST_SQUARE = getFastestSquareCost();
	}
	...
	float getFastestSquareCost()
	{
		...
		for(int x=0; x<1200; x++)
		{
			for(int y=0; y<600; y++)
			{
				if(getTravelSpeed(x,y)>fastest) fastest = getTravelSpeed(x,y);
			}
		}
